...
void Screen::initialize(int width, int height, int pixel_size_,
                        const bool pixels_[]) {
  ...
  pixels = pixels_;
  screen_texture =
      LoadRenderTexture(screen_width * pixel_size, screen_height * pixel_size);
}
...
void Screen::draw() { rlImGuiImageRenderTextureFit(&screen_texture, true); }
